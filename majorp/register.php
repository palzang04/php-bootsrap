				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation was-validated">
								...
								<div class="form-group m-0">
									<button type="submit" class="btn btn-primary btn-block" name="submit" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
										Register
									</button>
								</div>
